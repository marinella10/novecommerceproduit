...
<head>
    ...
    <title>PHP CRUD PAGE INSCRIPTION</title>
</head>
<body>
<header>
    <?php
...
<div class="container">
    <form method="post" id="form-register">
        <div class="text-center" id="logo-bg">
            <img src="image/imageslogoe.jpg" alt="logo ecommerce" title="ecommerce.com">
        </div>
...
//Debug des champs du formulaire form = method post + attrubut name=b en utilisant les var_dump popuir le mail , le password et password repeat""


//Desinfecter les champs avec sanitize
//lutter contre faille XSS = sanitize datas= filtre de nettoyage
...
if(isset($emailAdmin) && !empty($emailAdmin) && isset($passwordAdmin) && !empty($passwordAdmin)){
    ...
    if($passwordAdmin === $password_repeat_admin){
        ...
        //Executer la requète et retouner un tableau associatif  tableau qui associe des valeurs, a une cle.
